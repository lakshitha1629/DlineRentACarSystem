      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <div class="table-responsive">
            ...
            $qry = "SELECT * FROM user_account WHERE `user_type`='2' OR `user_type`='3' OR `user_type`='4' OR `user_type`='5' OR `user_type`='6' OR `user_type`='7' OR `user_type`='8' OR `user_type`='9' OR `user_type`='10'";
